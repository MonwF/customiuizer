...
public class System_ScreenshotConfig extends SubFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		String path = Helpers.prefs.getString("pref_key_system_screenshot_path", "1");
		String dir = Helpers.prefs.getString("pref_key_system_screenshot_mypath", "");
	...
	public void onActivityResult(int requestCode, int resultCode, final Intent data) {
		if (resultCode == Activity.RESULT_OK && requestCode == 0) {
			...
			if (dir == null) dir = "";
			findPreference("pref_key_system_screenshot_mypath").setSummary(dir);
			Helpers.prefs.edit().putString("pref_key_system_screenshot_mypath", dir).apply();
		}
