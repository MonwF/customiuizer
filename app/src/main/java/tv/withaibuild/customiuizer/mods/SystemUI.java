...
public class SystemUI {
                ...
                switch (event.getActionMasked()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (opt == 2) {
							...
							//noinspection WrongConstant -- hidden AudioManager.FLAG_FROM_KEY
    ...
    public static void BatteryIndicatorHook(PackageReadyParam lpparam) { SystemUIBatteryHooks.BatteryIndicatorHook(lpparam); }
...
//        });
    ...
    public static void StatusBarStyleBatteryIconHook(PackageReadyParam lpparam) { SystemUIBatteryHooks.StatusBarStyleBatteryIconHook(lpparam); }
